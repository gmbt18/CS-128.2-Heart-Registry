...
def records(request, year):
    ...
    months = sorted(set([r.date.month for r in record]),reverse=True)
    data = {'allrecords': allrecords, 'records':record, 'record_form' : record_form, 'years':years, 'months' : months, 'active_year' : year}
